...
public class ModelView extends Layout{
    ...
    public ModelView(Model model){
        ...
        if (this.model.getId() != 0) {
           // this.cmb_brand.setSelectedItem(new ComboItem(this.model.getBrand_id(), this.model.getBrand().getName()));
            this.fld_model_name.setText(this.model.getName());
            this.fld_model_year.setText(this.model.getYear());
            this.cmb_model_fuel.setSelectedItem(this.model.getFuel());
            this.cmb_model_gear.setSelectedItem(this.model.getGear());
            this.cmb_model_type.setSelectedItem(this.model.getType());
