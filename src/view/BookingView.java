...
public class BookingView extends Layout {
    ...
    public BookingView(Car selectedCar, String strt_date, String fnsh_date) {
        ...
        //test için
        this.fld_book_name.setText("Esra Şen");
        this.fld_book_idno.setText("12345678901");
        this.fld_book_mpno.setText("05321234567");
        this.fld_book_mail.setText("ess@patika.dev");
        this.fld_book_prc.setText("1000");
        this.txta_book_note.setText("test notu");
        //test için
